  ...
  promise.then(() => {
    ...
    ordered.forEach((ele) => {
      ...
      switch (ele) {
        ...
        case "Fries":
          img.src =
            "https://plus.unsplash.com/premium_photo-1672774750509-bc9ff226f3e8?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
          img.alt = "fries";
          break;
        case "Drink":
          img.src =
            "https://plus.unsplash.com/premium_photo-1725075086631-b21a5642918b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
          img.alt = "drink";
          break;
      }
